(function () {
    function init() {
        ...
        function detailHtml(item) {
            ...
            return '<div class="kanji-detail-meaning">' + escapeHtml(item.meaning) + '</div>' + jap + chi + examplesHtml;
        }
        ...
        function render() {
            ...
            grid.querySelectorAll('.card').forEach(function (card) { card.addEventListener('click', function (event) { if (event.target.closest('.speaker-btn')) return; card.classList.toggle('flipped'); }); });
