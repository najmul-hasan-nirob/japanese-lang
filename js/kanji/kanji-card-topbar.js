// Kanji card topbar controls.
(function () {
    const style = document.createElement('style');
    style.textContent = `
        .kanji-card > .lesson-card-topbar { display:grid!important; grid-template-columns:repeat(6,minmax(0,1fr))!important; align-items:center!important; justify-items:center!important; gap:0!important; width:100%!important; min-height:34px!important; white-space:nowrap!important; }
        ...
        .kanji-card > .lesson-card-topbar .kanji-stroke-btn,.kanji-card > .lesson-card-topbar .kanji-writing-practice-btn { font-size:17px!important; line-height:1!important; cursor:pointer!important; color:#fff!important; background:transparent!important; border:0!important; }
        ...
        @media (max-width:520px){ .kanji-card > .lesson-card-topbar { grid-template-columns:repeat(6,minmax(0,1fr))!important; } .kanji-card > .lesson-card-topbar button { width:28px!important;height:28px!important;min-width:28px!important; } .kanji-card > .kanji-stroke-section{padding:10px!important;} .kanji-stroke-stage{width:58vw!important;height:58vw!important;max-width:200px!important;max-height:200px!important;} }
    `;
    ...
    function setupCard(card){
        ...
        const topbar=document.createElement('div');topbar.className='lesson-card-topbar';topbar.setAttribute('aria-label','Card controls');
        ...
        topbar.append(star,number,stroke,tag,writing,speaker);card.insertBefore(topbar,inner);card.insertBefore(section,inner);card.dataset.kanjiTopbarReady='true';
    }
