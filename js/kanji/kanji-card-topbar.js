...
(function () {
    ...
    function setupCard(card){
        ...
        const star=document.createElement('button');star.type='button';star.className='hard-star';star.textContent='☆';star.setAttribute('aria-label','Mark as favourite');star.title='Mark as favourite';
