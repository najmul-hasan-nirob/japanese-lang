(function () {
    function init() {
        ...
        function primaryReading(kunyomi,onyomi){const value=String(kunyomi||onyomi||'').trim();if(!value)return '';const first=value.split(/[、,\/]/)[0].trim();return first.replace(/（.*?）/g,'').trim();}
